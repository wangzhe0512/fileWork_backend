...
SELECT UUID(), 'system', 'BVD数据模板-AP_YEAR',                   'BVD-AP年度',              'BVD', 'bvd', 'AP YEAR',             'A1',  NULL, NULL, 440, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-AP_Lead_Sheet_YEAR-13-19',  'BVD-AP Lead 13~19行',     'BVD', 'bvd', 'AP Lead Sheet YEAR',  'A13', NULL, NULL, 450, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-第一张表格',    'BVD-SummaryYear可比公司列表', 'TABLE_ROW_TEMPLATE', 'bvd', 'SummaryYear', NULL, '["可比公司列表","可比公司","Comparable Companies","Comparable Company"]', '["#","COMPANY"]', 460, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-MIN',           'BVD-SummaryYear最低值',   'BVD', 'bvd', 'SummaryYear',    'D_KEYWORD:MIN', NULL, NULL, 470, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-LQ',            'BVD-SummaryYear下四分位', 'BVD', 'bvd', 'SummaryYear',    'D_KEYWORD:LQ',  NULL, NULL, 480, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-MED',           'BVD-SummaryYear中位值',   'BVD', 'bvd', 'SummaryYear',    'D_KEYWORD:MED', NULL, NULL, 490, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-UQ',            'BVD-SummaryYear上四分位', 'BVD', 'bvd', 'SummaryYear',    'D_KEYWORD:UQ',  NULL, NULL, 500, 1, 0 UNION ALL
SELECT UUID(), 'system', 'BVD数据模板-SummaryYear-MAX',           'BVD-SummaryYear最高值',   'BVD', 'bvd', 'SummaryYear',    'D_KEYWORD:MAX', NULL, NULL, 510, 1, 0
